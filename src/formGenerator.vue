...
<div class="vue-form-generator columns" v-if="schema != null">
	<fieldset v-if="schema.fields" :is="tag" class="column"><template v-for="field in fields" >
